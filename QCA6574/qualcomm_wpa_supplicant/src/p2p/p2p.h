...
/* Added by Suntec
 * When DUT act as P2P_GO mode, after EAPOL finished, we have send out EAPOL-Failure to peer, 
 * then peer device will disassociate from DUT, and reassociate to DUT again.
 * So, set suntec_g_wait_disassociate to TRUE after DUT sent the EAPOL-Failure message.
 * otherwise, it should be FALSE;
 */
extern int suntec_g_wait_disassociate;
void suntec_set_disassociate_wait(int wait);
int suntec_get_disassociate_wait(void);
