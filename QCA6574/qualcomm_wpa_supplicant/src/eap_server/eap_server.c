...
static struct wpabuf * eap_sm_buildFailure(struct eap_sm *sm, u8 id)
{
    ...
    suntec_set_disassociate_wait(1);
				   ...
				   struct eap_config *conf)
{
    ...
    if(suntec_get_disassociate_wait() == 1)
    {
...
int suntec_g_wait_disassociate = 0;
void suntec_set_disassociate_wait(int wait)
{
    wpa_printf(MSG_ERROR, "Set suntec_g_wait_disassociate to %d\n", wait);
    suntec_g_wait_disassociate = wait;
}

int suntec_get_disassociate_wait(void)
{
    return suntec_g_wait_disassociate;
} 
