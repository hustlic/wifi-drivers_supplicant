...
L_CFLAGS = -DANDROID  #add by xushengliang
...
#ifeq ($(BOARD_WIFI_VENDOR), realtek) delete by xushengliang
...
LOCAL_STATIC_LIBRARIES := lib_driver_cmd_rtl #add by xushengliang
endif
LOCAL_CFLAGS := $(L_CFLAGS)
