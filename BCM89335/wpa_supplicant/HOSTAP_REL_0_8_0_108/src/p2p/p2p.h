...
struct p2p_peer_info {
	...
	/**
	 * mirror_link - mirror link subelements from IE(s)
	 */
	struct wpabuf *mrlnk_subelems;
#endif
...
#ifdef BCM_SDO
	/**
	 * ddo_enabled - Indicate device discovery offload status
	 */
	u8 ddo_enabled;
#endif /* BCM_SDO */
 ...
 * @p2p: P2P module context from p2p_init()
 * @p2p_pref_freq_5g: Preferred 5G freq
 * @p2p_pref_freq_2g: Preferred 2G freq
 * Returns: 0 on success, -1 on failure
 */
